...
def arguments_parser():
    ...
    parser.add_argument('--model_weights', type=str, default='', help='Path to the checkpoint to resume training')
    ...
    parser.add_argument('--model_name', type=str, default='medsam', help='Model name for SAM')
    parser.add_argument('--prompt_type', type=str, default='grid', choices=['grid', 'random', 'bbx'], help='Type of prompt for SAM')
