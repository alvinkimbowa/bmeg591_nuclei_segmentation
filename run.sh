...
#SBATCH --mem 64GB
#SBATCH --output /projects/ovcare/users/elahe_ranjbari/SAM/bmeg591_nuclei_segmentation/output_sam.out
#SBATCH --error /projects/ovcare/users/elahe_ranjbari/SAM/bmeg591_nuclei_segmentation/error_sam.out
